<template>
	<div id="app" >
		<p><strong> {{usuarioSelecionado.nome }}</strong></p> 
		<p><strong> {{usuarioSelecionado.id }}</strong></p> 
		<usuario-lista :usuarios="usuarios" @usuarioMudou="usuarioSelecionado = $event"	/>
		
		<usuario-detalhe  :id="usuarioSelecionado.id" :nome="usuarioSelecionado.nome"    />
	</div>
</template>
